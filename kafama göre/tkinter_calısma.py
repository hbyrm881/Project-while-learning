...
buton_ekle = tk.Button(buton_cerceve, text="Ekle",width=15, height=2,command=ekle)  
buton_ekle.pack(side="left",padx=5)  

buton_sil = tk.Button(buton_cerceve, text="Sil",width=15, height=2, command=sil)
buton_sil.pack(side="left",padx=5)
